            ...
            if self._retrieval_num != 0:
                if self._retrieval_id == 'Full_Random':
                    ...
                    if self._input_retrieval_id == 'Full_Random':
                        profiles_for_input = self.__sample_among_users(batch_size*self._retrieval_num, batch_size, self._retrieval_num, retrieval_fn['input'])
                    else:
                        profiles_for_input = [
                    ...
                    if self._output_retrieval_id == 'Full_Random':
                        profiles_for_output = self.__sample_among_users(batch_size*self._retrieval_num, batch_size, self._retrieval_num, retrieval_fn['output'])
                    else:
                        profiles_for_output = [
